"""Path: 1st code raises in sandbox, repair succeeds on 2nd."""

from __future__ import annotations

from discogs_agent.llm import stub as stub_module

_QUERY = "Trigger validation retry"


def test_validation_retry_then_success(agent_env: dict) -> None:
    qhash = stub_module._hash_query(_QUERY)

    # 1st code-gen passes safety but raises at runtime (no RESULT).
...
raise RuntimeError("stub failure on first attempt")
"""
